...
- [`pl_get_dependencies()`](https://your-org.github.io/pocketlogR/reference/pl_get_dependencies.md)
...
- [`pl_success()`](https://your-org.github.io/pocketlogR/reference/pl_success.md)
  : Log a SUCCESS event
- [`pl_error()`](https://your-org.github.io/pocketlogR/reference/pl_error.md)
  : Log an ERROR event
- [`pl_fatal()`](https://your-org.github.io/pocketlogR/reference/pl_fatal.md)
  : Log a FATAL event
...
- [`pl_delete_flow()`](https://your-org.github.io/pocketlogR/reference/pl_delete_flow.md)
  : Delete a flow (admin only)
- [`pl_delete_logs()`](https://your-org.github.io/pocketlogR/reference/pl_delete_logs.md)
